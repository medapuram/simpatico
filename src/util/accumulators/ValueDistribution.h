#ifndef UTIL_VALUE_DISTRIBUTION_H
#define UTIL_VALUE_DISTRIBUTION_H
...
namespace Util
{
   ...
   */
   class ValueDistribution : public ParamComposite 
   {
   ...
   public:
      ...
      * Copy constructor.
      *
      * \param other ValueDistribution to be copied.
      */
      ValueDistribution(const ValueDistribution& other);
   
      /** 
      * Assignment operator.
      *
      * \param other ValueDistribution to be assigned.
      */
      ValueDistribution& operator = (const ValueDistribution& other);
      ...
      */
      ...
      /**
      * Serialize this ValueDistribution to/from an archive.
      *
      ...
      */
      void sample(double value, double binValue);
      ...
      */
      int binIndex(double binValue) const;
   ...
   * Return the index of the bin for a value.
   */
   inline int ValueDistribution::binIndex(double binValue) const
   { return int( (binValue - min_)/binWidth_ ); }
  
   /*
   * Get minimum value in range of histogram.
   */
   inline double ValueDistribution::min() const
   {  return min_; }
  
   /*
   * Get maximum value in range of histogram.
   */
   inline double ValueDistribution::max() const
   {  return max_; }
 
   /*
   * Get binWidth, the width of each bin.
   */
   inline double ValueDistribution::binWidth() const
   {  return binWidth_; }
  
   /*
   * Get the number of bins
   */
   inline int ValueDistribution::nBin() const
   {  return nBin_; }

   /*
   * Serialize this ValueDistribution.
   */
   template <class Archive>
   void ValueDistribution::serialize(Archive& ar, const unsigned int version)
   {
      ar & min_;        
      ar & max_;    
      ar & nBin_;     
