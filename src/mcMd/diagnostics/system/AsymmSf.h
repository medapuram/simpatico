#ifndef MCMD_ASYMM_SF_H
#define MCMD_ASYMM_SF_H
...
namespace McMd
{
   ...
   */
   class AsymmSf : public SystemDiagnostic<System>
   {
   ...
   */
   template <class Archive>
   void AsymmSf::serialize(Archive& ar, const unsigned int version)
   {
