#ifndef DDMD_ASYMM_SF_GRID_H
#define DDMD_ASYMM_SF_GRID_H
...
namespace DdMd
{
   ...
   /**
   * AsymmSFGrid evaluates structure factors in Fourier space.
   *
   ...
   */
   ...
   public:
      ...
      */
      AsymmSFGrid(Simulation &simulation);
